...
class Crud extends CI_Controller {
    ...
    $this->form_validation->set_rules('produsen', 'produsen', 'trim|required|min_length[5]|max_length[45]');
    $this->form_validation->set_rules('harga', 'harga', 'trim|required|min_length[3]|max_length[14]');
	...
	public function update()
	{
		...
		$this->form_validation->set_rules('nama', 'nama', 'trim|required|min_length[3]|max_length[45]');
		$this->form_validation->set_rules('produsen', 'produsen', 'trim|required|min_length[5]|max_length[45]');
		$this->form_validation->set_rules('harga', 'harga', 'trim|required|min_length[5]|max_length[14]');
